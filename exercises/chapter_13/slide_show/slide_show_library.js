...
SlideShow.prototype.changeFastSpeed = function () {
    var that = this;

    // Get the new value from the Fast Speed selection list
    
    // Set the fast speed to the correct number of milliseconds
    
    // Set the speed to the new fast speed
    
    // Cancel the old timer and start a new timer    
    
    // If in Slow mode, change to Fast mode

    // If in Pause mode, switch to Play mode
